...
public class OptionMenu : MonoBehaviour
{
    ...
    {
        if (AudioManagerY.Instance.GetAudioPlayers()[volumeIndex] != null)
        {
            //AudioManager.Instance.GetAudioPlayers()[volumeIndex].GetComponent<AudioSource>().volume = volumeSlider[volumeIndex].value; 
            AudioSource[] sources = AudioManagerY.Instance.GetAudioPlayers()[volumeIndex].GetComponents<AudioSource>();
